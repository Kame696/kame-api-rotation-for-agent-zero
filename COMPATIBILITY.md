...
**KAME 1.8.1.2 — compatibility re-verified against Agent Zero v2.12 (2026-09-23), and run in a real v2.12 session with real keys (12/12 answered).**
...
| **V2.12** | **1.8.1.2** | **verified — current baseline** | `tools/a0_upgrade_check.py` all green on a fresh v2.12 checkout (symbols, host facts, live harness); `tools/live_a0_session.py` 12/12 real calls answered. |
